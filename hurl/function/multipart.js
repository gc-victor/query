const funFunFunction = `globalThis.___handleRequest = async (req) => {
    try {
        ...
        const str = \`email: \${email} | password: \${password} | file: \${field.name} - \${field.type} - \${field.size} | duplicated: \${duplicated}\ | duplicatedArray: \${Array.isArray(duplicated)}\ | list: \${list} | listArray: \${Array.isArray(list)}\`;
