...
- [CLI](#cli)
  ...
  - [Commands](#commands)
    ...
    - [Plugin](#plugin)
      ...
      - [Push Plugins](#push-plugins)
- [Plugins System](#plugins-system)
  - [How to Use a Plugin](#how-to-use-a-plugin)
    - [Install a WASM Plugin](#install-a-wasm-plugin)
    - [Use a WASM Plugin](#use-a-wasm-plugin)
- [APIs](#apis)
...
> [!IMPORTANT]
> The `dev` task will be executed on dev mode before the rest of the default commands.
