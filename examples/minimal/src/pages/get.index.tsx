            ...
            <>
                ...
                <body class="bg-slate-100 text-slate-900">
                    <div class="container mx-auto pt-12 p-4">
                        <h1 class="text-4xl font-cal mb-4 text-slate-700">Minimal</h1>
                        <p class="text-lg mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                        <ul class="flex gap-4 mb-4">
                            <li><a href="/no-dynamic" class="text-blue-600 hover:text-blue-800 underline">No Dynamic</a></li>
                            <li><a href="/dynamic" class="text-blue-600 hover:text-blue-800 underline">Dynamic</a></li>
                        </ul>
