...
import type { Navigation, Toc } from "../types";

export const DocumentTemplate = ({ content, navigation, toc }: { content: JSX.Element | string, navigation: Navigation | null | undefined, toc: Toc }) => {
    return (
